...
public class GLRenderer implements Renderer {
	...
	private void drawStatus(GL10 gl) {
		...
		if (this.application_state == ProcessManager.PM_MAINTITLE_STATE) {
			...
			gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);// ���_�o�b�t�@���L����
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, this.frame_panel_vertices);// ���_�o�b�t�@��Open
																				// GL���R�t��
	...
	public void drawFrame(GL10 gl) {
		...
		gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);// ���_�o�b�t�@���L����
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, this.back_panel_vertices);// ���_�o�b�t�@��Open
																			// GL���R�t��
		gl.glDrawArrays(GL10.GL_TRIANGLES, 0, 6);
		gl.glPopMatrix();
